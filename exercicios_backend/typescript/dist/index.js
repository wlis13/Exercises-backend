...
const Ex = __importStar(require("./exercise"));
...
console.log(`- diagonal Y: 32cm e diagonal X: = 18cm: ${Ex.getLosangoArea(32, 18)}`);
console.log(`- diagonal Y: 200cm e diagonal X: = 50cm: ${Ex.getLosangoArea(200, 50)}`);
console.log(`- diagonal Y: 75cm e diagonal X: = 25cm: ${Ex.getLosangoArea(75, 25)}`);
console.log(`
...
console.log(`Calcule a área de um círculo de raio igual 25cm ${Ex.getCircleArea(25)}`);
console.log(`Calcule a área de um círculo de raio igual 100cm ${Ex.getCircleArea(100)}`);
console.log(`Calcule a área de um círculo de raio igual 12,5cm ${Ex.getCircleArea(12.5)}`);
